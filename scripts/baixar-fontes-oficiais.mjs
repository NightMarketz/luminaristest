...
const FONTES = [
  ...
  // ---- Custo de aquisicao por regime (X6, BRIEF BE-INCR-NFE-COST-REGIME §4 f1/f6/f7/f8) ----
  // Autorizado pelo dono em 2026-09-15 (questionario na sessao PROXIMOS-PASSOS-2026-09-14 passo 8).
  {
    id: 'rir-2018',
    assunto: 'Custo de aquisicao — tributo recuperavel nao integra o custo (art. 301 §3)',
    titulo: 'Decreto 9.580/2018 (RIR/2018)',
    tipo: 'arquivo',
    url: 'http://www.planalto.gov.br/ccivil_03/_ato2015-2018/2018/decreto/d9580.htm',
    arquivo: 'Decreto-9580-2018-RIR.html',
  },
  {
    id: 'lei-10637-2002',
    assunto: 'PIS nao-cumulativo — credito 1,65% (art. 2/3)',
    titulo: 'Lei 10.637/2002',
    tipo: 'arquivo',
    url: 'http://www.planalto.gov.br/ccivil_03/leis/2002/l10637.htm',
    arquivo: 'Lei-10637-2002-PIS.html',
  },
  {
    id: 'lei-10833-2003',
    assunto: 'COFINS nao-cumulativa — credito 7,6% (art. 2/3), monofasico sem credito (art. 3 §2 II), bebidas (art. 58-A)',
    titulo: 'Lei 10.833/2003',
    tipo: 'arquivo',
    url: 'http://www.planalto.gov.br/ccivil_03/leis/2003/l10.833.htm',
    arquivo: 'Lei-10833-2003-COFINS.html',
  },
  {
    id: 'lei-14592-2023',
    assunto: 'ICMS fora da base do credito de PIS/COFINS (art. 6)',
    titulo: 'Lei 14.592/2023',
    tipo: 'arquivo',
    url: 'http://www.planalto.gov.br/ccivil_03/_ato2023-2026/2023/lei/l14592.htm',
    arquivo: 'Lei-14592-2023.html',
  },
  {
    id: 'lei-10147-2000',
    assunto: 'Monofasico — farmacia/perfumaria (NCM, F-X6-7 a)',
    titulo: 'Lei 10.147/2000',
    tipo: 'arquivo',
    url: 'http://www.planalto.gov.br/ccivil_03/leis/l10147.htm',
    arquivo: 'Lei-10147-2000-monofasico-farmacia.html',
  },
  {
    id: 'lei-10485-2002',
    assunto: 'Monofasico — autopecas/veiculos (NCM, F-X6-7 a)',
    titulo: 'Lei 10.485/2002',
    tipo: 'arquivo',
    url: 'http://www.planalto.gov.br/ccivil_03/leis/2002/l10485.htm',
    arquivo: 'Lei-10485-2002-monofasico-autopecas.html',
  },
  {
    id: 'lei-10865-2004',
    assunto: 'PIS/COFINS-Importacao e aliquotas por produto (monofasico, F-X6-7 a)',
    titulo: 'Lei 10.865/2004',
    tipo: 'arquivo',
    url: 'http://www.planalto.gov.br/ccivil_03/_ato2004-2006/2004/lei/l10.865.htm',
    arquivo: 'Lei-10865-2004.html',
  },
  {
    id: 'lei-9718-1998',
    assunto: 'Monofasico — combustiveis (art. 4, F-X6-7 a)',
    titulo: 'Lei 9.718/1998',
    tipo: 'arquivo',
  ...
  },
  {
    ...
    titulo: 'Lei Complementar 123/2006',
    tipo: 'arquivo',
