...
estado: "planned"
estado_detalhe: "Fase 3.1 do plano pós-contador — requisito NOVO trazido pela resposta do contador (23/09), sem spec. Toca estoque, crédito do X6 e ICMS de uso e consumo; default por produto + override por item; migração. ADR se mudar o modelo de Product"
depende_de: ["[[FIS-08]]", "[[X6]]", "[[D1]]"]
ancora_sdd: "§III.2 (fora da régua até BRIEF/ADR próprios)"
atualizado: "2026-09-25"
---
# ITEM-DESTINATION — Destinação por item na entrada (revenda × insumo do serviço)

**Estado:** `planned` — Fase 3.1 do plano pós-contador — requisito NOVO trazido pela resposta do contador (23/09), sem spec. Toca estoque, crédito do X6 e ICMS de uso e consumo; default por produto + override por item; migração. ADR se mudar o modelo de Product  
...
**Desbloqueia:** —  
**Âncora no SDD consolidado:** §III.2 (fora da régua até BRIEF/ADR próprios)
