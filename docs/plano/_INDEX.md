...
| Nó | Título | Estado | Depende de (✗ = aberto) | Autorização |
| --- | --- | --- | --- | --- |
| [[CRM-RB]] | Builder de relatórios/dashboards self-service do CRM (BE-INCR-CRM-REPORT-BUILDER) | planned — BRIEF em PR (26/09); 7 forks PENDENTES; reabre ADR-ANALYTICS-DEFS via F-AD5; código não iniciado; execução exige 'executa' | [[I8]] ✗ | "autorizo planejar o builder de relatórios do CRM" 2026-09-26 (só planejamento — sem 'executa') |
