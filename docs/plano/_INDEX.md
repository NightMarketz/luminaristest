...
| [[I8]] | CRM como categoria composta por módulos (BE-INCR-CRM-MODULE-COMPOSITION) | inflight — passos 1–3 do BRIEF (comportamentos 1, 4, 7: registro, crmModule=composição, 409 CRM_MODULE_NOT_INSTALLED) em PR aberto; resto PARADO em fork (tenant clínica sem CRM + PresetSyncService lê leads do Core) | [[I1]] | F-I8-1 → (d) + 9/9 forks 2026-09-07; 'executa o I8' (dono, chat, 2026-09-26) |
