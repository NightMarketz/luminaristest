...
| [[X13]] | Perfil de obrigações por empresa — regime × porte, capturado no onboarding (BE-INCR-FISCAL-OBLIGATION-PROFILE) | planned — PRE-ADR aceito 24/09 (10 forks na recomendação); BRIEF 24/09; F-XP-1..8 ratificados 24/09; PR-1 autorizado e em execução; PR-2/PR-3 exigem executa; PR-3 depende de I1 | [[D-2026-09-24-FISCAL-OBLIGATION-PROFILE]], [[I1]] ✗ | F-OBP-0..9 + F-XP-1..8 ratificados; "executa X13 PR-1" (dono, 24/09) — só PR-1 |
