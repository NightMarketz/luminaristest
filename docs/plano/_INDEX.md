...
| [[X13]] | Perfil de obrigações por empresa — regime × porte, capturado no onboarding (BE-INCR-FISCAL-OBLIGATION-PROFILE) | planned — PRE-ADR aceito 24/09 (10 forks na recomendação); BRIEF escrito 24/09 com forks F-XP-* pendentes; código exige 'executa'; PR-3 depende de I1 | [[D-2026-09-24-FISCAL-OBLIGATION-PROFILE]], [[I1]] ✗ | F-OBP-0..9 ratificados (dono, 24/09) — planejamento; execução sem 'executa' |
