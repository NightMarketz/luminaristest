...
| T2 | `referential_mappings` e `referential_accounts` têm **zero linhas** no `dev.db` real: `coverage.ready=false`, o passo 3 do H1 recusa com 400. | verificado | X2, H1 |
...
5. **P5 — cobertura referencial.** `[DONO confere]`: na aba **Compliance**, mapear as **9 contas-folha**
