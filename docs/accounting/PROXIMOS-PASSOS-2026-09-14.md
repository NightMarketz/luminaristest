...
### Passo 10 — C8 imobilizado + depreciação ⬜
...
| 10.3 | BRIEF via `sessao-planejamento` | BRIEF | ⬜ |

### Passo 11 — Pedido ao contador ⬜
...
| 11.5 | Montar com `luminaris-contador-liaison`; **dono envia**; resposta vira artefato checável, nunca sign-off | pacote | [H] envio |

### Passo 12 — Fold 🟡 parcial
