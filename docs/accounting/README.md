...
|---|---|---|
| [`ACCOUNTING-MASTER-MAP.md`](ACCOUNTING-MASTER-MAP.md) | grafo-mestre reconciliado: §1 travadas · §4 rejeitadas · §5 diferidos · **§5.1 fila** · **§7.1 régua** · fold no topo | régua **44/57**; último fold: 17/09 (C6b ✅ #340) |
...
| [`PROXIMOS-PASSOS-2026-09-17.md`](PROXIMOS-PASSOS-2026-09-17.md) | prompt de orquestração pós-C6b + **detalhamento por passo** (sucede o 09-14, que fechou 11/12) | vigente — 1–3 ✅ (#338 · #340 · #339), 4–8 [H] |
