...
> **antes** do swap (feature `04582d8a` é de 21/08) — e seus passos citam as abas do painel contábil
> genérico, **não** o fluxo de venda de salão especificamente; não cobre o caminho que agora passa
> pelo intérprete/binding compilado. Ver §5.1 Bloco A item 4 (eventos a carimbar).
>
...
>
> **⚠️ Antes do merge — a branch está velha:** `origin/main` tem **156 commits que a branch não tem**
> (`git rev-list --count 68df00f4..origin/main`). Tocam superfícies que a NF-e edita: `PayableDto`
