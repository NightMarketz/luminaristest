...
| **Financeiro** | ~~13/17~~ **14/17 (82%, fold 2026-09-08: nó 17 NF-e de compra pela tela ✅ #286)** | 14/18 | ~~NF-e compra (em voo)~~, baixa parcial AP/AR (ADR Proposed ✅ #276 `b7a62a73` + parecer, 2026-09-07, 7 forks pendentes, CAS reformulado + 2 tie-outs a corrigir), caixa projetado (BRIEF ✅ #278 `77c77553`, 2026-09-07, 7 forks pendentes), remessa CNAB/boleto/Pix (ADR + dado do banco) | H2 (upload por clique) |
| **Fiscal** | ~~4/12~~ ~~4/13~~ **5/13 (38%, fold 2026-09-08: nó 8 NF-e BE+UI ✅ #267/#283/#286; nó transversal CNPJ alfanumérico ✅ #280)** | 5/15 | tela import catálogo + botão ECF Real (BRIEF ✅ #279 `5daa8763`, 2026-09-07, 7 forks pendentes), blocos L/M/N, NF-e, apuração de tributos (ADR), EFD-Contribuições (ADR, raso, por último), DCTFWeb (ADR), D3 sob Lucro Real, **emissão de DF-e via parceiro emissor (ADR, F-M7)** | X2, H1, H1 2ª passada, **parceiro emissor + certificado** |
