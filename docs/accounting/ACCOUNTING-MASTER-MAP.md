...
>
> **🔁 FOLD 2026-09-11 (3ª passada) — ECF FASE 3B: BRIEF `BE-INCR-SPED-ECF-FASE3B-blocos-LMN` + 5 forks RATIFICADOS + Passo A transcrito + §2 EMENDADO (PR #311, aberto — NÃO em `main`).**
...
> transportado ao `E020` seguinte (nota N-1, forma aberta). **Régua inalterada: 40/57** — nada mergeado em `main`; fiscal segue 7/16.
> **Achado do fold:** o PR #311 carrega o master map **desatualizado** (base `66465eaa`, anterior aos folds #306/#310) — **tem de rebasear antes
> de mergear** ou reverte esta pilha de folds (classe "squash-merge sobre branch desatualizada reverte o pai"). D3b (corpus em `main`) agora TEM PR: #311.
>
...
> Fase 3 **não estão em `main`** (branch local `claude/mit-api-integration-queue-0e8847`, ~~sem PR~~ **PR #311 aberto em 11/09**) — nó D3b do grafo.
>
...
| **Total** | ~~38/49 (78%)~~ ~~38/57 (67%)~~ ~~39/57 (68%)~~ **40/57 (70%, fold 2026-09-11, 2ª passada)** | +8 | — |
