...
> | **F7** baixa por retorno bancário (tabela irmã, R9) | B — financeiro | ✅ **MERGEADO** #326 `22b97252` (forks ratificados 14/09); contas de encargo = item 6 do pedido | `BE-INCR-BANK-SETTLEMENT-brief.md` |
