...
// +4 (BE-INCR-PARTIAL-SETTLEMENT): rotas-irmãs /settlements (AP+AR) — F-PS10 → b (156 → 160).
...
// +1 (BE-INCR-CRM-MODULE-COMPOSITION, I8 comportamento 8): POST /dashboard/modules/install — 218 → 219.
const BASELINE = 219;
