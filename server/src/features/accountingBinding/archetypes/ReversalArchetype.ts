 ...
 * `server/src/features/accounting/sync/mappers/SaleReturnedMapper.ts` (`P1-DOSSIER-arquetipos.md` §2.3).
 *
 ...
 *
 *   Débito  contra-receita       = amount   (SaleReturnedMapper.ts:21)
 *   Crédito controle-recebível   = amount   (SaleReturnedMapper.ts:22)
 */
  ...
  slots: [
    {
      name: 'amount',
      type: 'moneyReais',
      // Guards do mapper original (SaleReturnedMapper.ts:32-46).
